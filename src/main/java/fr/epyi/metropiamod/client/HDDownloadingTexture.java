...
@OnlyIn(Dist.CLIENT)
public class HDDownloadingTexture extends DynamicTexture {

    private static final Logger LOGGER = LogManager.getLogger();

    private ResourceLocation textureLocation = new ResourceLocation(MetropiaMod.MOD_ID, "textures/entity/alex.png");
    @Nullable
    ...
    public HDDownloadingTexture(@Nullable String cacheFileIn, String imageUrlIn, ResourceLocation textureResourceLocation, boolean isTransparent, @Nullable Runnable processTaskIn) {
        super(512, 512, true);
            ...
            if (nativeimage != null) {
                ...
                this.future = CompletableFuture.runAsync(() -> {
                    ...
                    try {
                        ...
                        NativeImage nativeimage_1 = this.loadTexture(inputStream);
